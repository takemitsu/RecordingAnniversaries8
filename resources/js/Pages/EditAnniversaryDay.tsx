...
export default function EditAnniversaryDay({ entityData, dayData }: { entityData: Entity; dayData: Day }) {
    ...
    const [selectDate, setSelectDate] = useState(
        dayData ? setTimeZero(dayData.anniv_at) : setTimeZero(dayjs().toISOString()),
    );
    const [reki, setReki] = useState(
        dayData ? japanDate(dayData.anniv_at, true) : japanDate(dayjs().format('YYYY-MM-DD'), true),
    );
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            <DatePicker
                                ...
                                open={false}
                            />
                            <div className="flex-wrap flex-shrink-0 ml-2 text-gray-600 dark:text-gray-200">{reki}</div>
                        </div>
                        <DatePicker
                            selected={selectDate}
                            onChange={onHandleChangeAnnivAt}
