...
export default function Years() {
    ...
    return (
        <div className="min-h-screen flex flex-col sm:justify-center items-center pt-0 sm:pt-0 bg-gray-100 dark:bg-gray-900">
            ...
            <div className="w-full sm:max-w-md mt-3 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
                <Head title="西暦/和暦一覧" />
                <main>
                    <div className="flex items-center justify-start gap-6">
                        <div>
                            <h2 className="text-xl font-semibold text-black dark:text-white">年度一覧</h2>
                        ...
                        <table className="border-collapse border border-slate-500">
                            ...
                            <tbody>
                                {years.map((year: number, i: number) => (
                                    <tr key={`ty${year}`}>
                                        <td className="border border-slate-600 px-2 py-1 text-gray-400 dark:text-gray-400 text-right">
                                            {i}
                                        </td>
                                        <td className="border border-slate-600 px-2 py-1 text-gray-400 dark:text-gray-400">
